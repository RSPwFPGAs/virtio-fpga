...
//    $fclose(file);
  ...
  always begin
    ...
    if (`CSR_PATH.csr_drv_ok) begin
      ...
      // read descriptor 2*16B
          debug_trace_rd(virt_queue_phy+(0)+descr_idx*16+ 0, data2);              $display("3");
          debug_trace_rd(virt_queue_phy+(0)+descr_idx*16+32, data2);              $display("4");

...
//    $fclose(file);
  ...
  //        // TODO: thread 3: read descriptor, num*chain_entry*16B, 128b
  ...
  //      end
  //    
  //      // TODO: thread 4: read/write buffer, send/receive packets, 256b
  //      
  //      if (1) begin  // pretending to send/receive packets
  //        // TODO: thread 5: write used ring entry, len+id, num*8B, 64b
